#!/bin/sh 
## wget --no-check-certificate -P /home/pirate https://raw.githubusercontent.com/TamataOcean/rpi_wifi_direct/master/raspberry_pi4/install_wifi_direct.sh; chmod +x /home/pi/install_wifi_direct.sh; bash -x /home/pi/install_wifi_direct.sh
...
sudo wget --no-check-certificate -P /etc/default https://raw.githubusercontent.com/TamataOcean/rpi_wifi_direct/master/raspberry_pi4/hostapd &&
sudo mv /etc/dnsmasq.conf /etc/dnsmasq.conf.orig &&
sudo wget --no-check-certificate -P /etc https://raw.githubusercontent.com/TamataOcean/rpi_wifi_direct/master/raspberry_pi4/dnsmasq.conf &&
sudo mv /etc/sysctl.conf /etc/sysctl.conf.bak &&
sudo wget --no-check-certificate -P /etc https://raw.githubusercontent.com/TamataOcean/rpi_wifi_direct/master/raspberry_pi4/sysctl.conf &&
